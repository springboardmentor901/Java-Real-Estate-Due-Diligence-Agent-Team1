...
System.out.println("RAPIDAPI LOCATION: " + location);

        RapidApiListingResponse response =
                rapidApiListingClient.searchListings(location);
        ...
        List<RapidApiListingResponse.Listing> listings =
                response.getData() != null
                        ...
                        : List.of();
                        System.out.println("RAPIDAPI RESULTS COUNT: " + listings.size());
